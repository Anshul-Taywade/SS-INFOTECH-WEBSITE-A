...
export default function PortfolioProjects() {
  ...
  return (
    <section id="portfolio" className="relative py-24 md:py-32 px-6 md:px-12 lg:px-16 xl:px-20 w-full max-w-[1536px] mx-auto">
          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div>
                ...
                {/* Title */}
                <Link href="/solutions" className="block cursor-pointer">
